        ...
        <form class="login-form">
          ...
          <div class="row">
            <div class="input-field col s6 m6 l6">
              <p class="margin medium-small"><a href="register">现在注册!</a></p>
            </div>
            <div class="input-field col s6 m6 l6">
              <p class="margin right-align medium-small"><a href="forgotpassword">忘记密码?</a></p>
            </div>
          </div>
        </form>
      </div>
      ...
      doLogin() {
        ...
        this.axios.get(url, {
          ...
          if (response.data.code == 200) {
            ...
            //2.页面跳转了。
            window.location.href = '/'; //跳转到pc端默认的首页。
